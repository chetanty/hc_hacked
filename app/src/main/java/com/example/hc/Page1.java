 ...
 * <p>
 * You'll need a map with filename alberta.map from download.mapsforge.org in device storage.
 */
public class
Page1 extends Activity {
    ...
    private void openMap(Uri uri) {
        try {
             ...
             * Note: this map position is specific to Edmonton area.
             */
            mapView.setCenter(new LatLong(53.5461, -113.4938));
